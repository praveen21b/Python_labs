# -*- coding: utf-8 -*-
"""
Created on Sun Nov 21 11:07:49 2021
...
def nested_extraction(lists, numb):
     return lists[numb][numb]
...
def long_word_in_collection(lists,string):
    return string in lists and len(string)>4
